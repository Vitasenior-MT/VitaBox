<template>
  <div class="row">
    ...
    <div class="row" v-show="examEvent == 'bloodpressure'">
      <div class="col-md-12">
        <div class="col-md-8">
          <div class="card">
            <div class="header">
            ...
            <div class="content">
              <table class="table table-Striped">
                ...
                <tbody>
                  <tr>
                    <td>
                      <h4>
                        ...
                        <br>
                        Ajuste a bracelete conforme mostrado na imagem.
                      </h4>
                    </td>
                  ...
                  <tr>
                    <td>
                      <h4>Percione no botão para ligar <b class="ti-power-off"></b>.</h4>
                    </td>
                    <td>
    ...
    <div class="row" v-show="examEvent == 'bodyscale'">
      <div class="col-md-12">
        <div class="col-md-8">
          <div class="card">
            <div class="header">
        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="content">
              :class="bodyscaleClass" bodyscale
            </div>
            <div class="footer">
            </div>
          </div>
    ...
    <div class="row" v-show="examEvent == 'bloodglucose'">
      <div class="col-md-12">
        <div class="col-md-8">
          <div class="card">
            <div class="header">
    ...
    <div class="row" v-show="examEvent == 'bodytemperature'">
      <div class="col-md-12">
        <div class="col-md-8">
          <div class="card">
            <div class="header">
              ...
              <table class="table table-Striped">
                ...
                <tbody>
                  <tr>
                    <td>
                      <h4>
                        Coloque o equipamento conforme mostrado na imagem.
                      </h4>
                    </td>
    ...
    <div class="row" v-show="examEvent == 'bodypulse'">
      <div class="col-md-12">
        <div class="col-md-8">
          <div class="card">
            <div class="header">
              ...
              <table class="table table-Striped">
                ...
                <tbody>
                  <tr>
                    <td>
                      <h4>
                        Coloque o dedo conforme apresentado na imagem.
                      </h4>
                    </td>
        ...
        if (!self.execProcess) {
          ...
          switch (cmd) {
            ...
            case 'right': // tecla para a direita
              ...
              self.examEvent = EventBus.elementControl[EventBus.currentActiveRightComp].dataset.type.toLowerCase()
              break
