...
var BleServer = function (data) {
  ...
  this.sensors = (function () {
    ...
    for (let index = 0; index < data.sensors.length; index++) {
      arr[data.sensors[index].transducer] = data.sensors[index];
    }
    return arr;
  })();
          ...
          characteristic.on('read', function (data, isNotification) {
            ...
            if (isNotification && data) {
              ...
              let dataSave = [{
                ...
                transducer: "weight",
                datetime: new Date(),
                value: (Math.round(scaleData.weight * 100) / 100)
              }, {
                id: self.pacientId + "-" + self.macAddress,
                bio: true,
                board_id: self.boardId,
                ...
                transducer: "bodyfat",
                datetime: new Date(),
                value: (Math.round(scaleData.bodyfat * 100) / 100)
              }, {
                id: self.pacientId + "-" + self.macAddress,
                bio: true,
                board_id: self.boardId,
                ...
                transducer: "bonemass",
                datetime: new Date(),
                value: (Math.round(scaleData.bonemass * 100) / 100)
              }, {
                id: self.pacientId + "-" + self.macAddress,
                bio: true,
                board_id: self.boardId,
                ...
                datetime: new Date(),
                value: (Math.round(scaleData.musclemass * 100) / 100)
              }, {
                id: self.pacientId + "-" + self.macAddress,
                bio: true,
                board_id: self.boardId,
                ...
                datetime: new Date(),
                value: (Math.round(scaleData.visceralfat * 100) / 100)
              }, {
                id: self.pacientId + "-" + self.macAddress,
                bio: true,
                board_id: self.boardId,
                ...
                transducer: "water",
                datetime: new Date(),
                value: (Math.round(scaleData.water * 100) / 100)
              }, {
                id: self.pacientId + "-" + self.macAddress,
                bio: true,
                board_id: self.boardId,
                ...
                transducer: "calories",
                datetime: new Date(),
                value: (Math.round(scaleData.calories * 100) / 100)
              }];
  ...
  utilsBle.nobleCaracteristicRead(characteristic, function (data) {
    if (data) {
      ...
      let dataSave = [{
        ...
        bio: true,
        board_id: self.boardId,
        sensor_id: self.sensors["callories"].id,
