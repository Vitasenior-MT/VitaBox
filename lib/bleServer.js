      ...
      utilsBle.nobleCaracteristicRead(characteristic, function () {
        characteristic.on('read', function (data, isNotification) {
          ...
          if (data && isNotification) {
            ...
            var pulse_low = data.readInt8(12);
            pulse_low &= 0b01111111;

            var pulse_high = data.readInt8(11);
            ...
            spo2 = data.readInt8(13);
            spo2 &= 0b01111111;


            if ((pulse_spo2 >= 25) && (pulse_spo2 <= 250) && (pulse_spo2 >= 35) && (pulse_spo2 <= 100)) {
              console.log("                   If teste.");
            }
            // pulse_spo2 = data.readInt8(3);
            // spo2 = data.readInt8(4);

            console.log("                   Send Pulse: " + pulse_spo2 + "ppm, pos: 4");
            console.log("                   Send SpO2: " + spo2 + "%, pos: 5");
            var str = '';
