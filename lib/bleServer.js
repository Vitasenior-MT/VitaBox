          ...
          utilsBle.nobleDeviceReturnDiscriptor(characteristicgluco, '2902', function (descriptorA) {
              ...
              utilsBle.nobleDeviceReturnService(device, ["fff0"], function (service) {
                ...
                utilsBle.nobleDeviceReturnCaract(service, ["fff1"], function (characteristic) {
                   ...
                   * TODO: Envia o comando para o descritor
                   */
                  utilsBle.nonleDescriptorWriteCommand(descriptorA, command, function () {
                    
                    /**
                     * TODO: Envia o comando para o descritor
                     */
                    utilsBle.nonleDescriptorWriteCommand(descriptorB, command, function () {
                      utilsBle.sendMsgCommand(true, "bleMsg", "Inserir a tira de sangue (20s).", false);     
                      sleep.sleep(20);
                      characteristic.on('read', function (data, isNotification) {
                        /**
                         * TODO: Recebeu dados 
                        ...
                        if (data && isNotification) {
                          ...
                          let newDataSensors = [];
                          newDataSensors["bloodglucose"] = glucose.split("=")[1].replace(/\r\n/g, "").replace("mg_dL", "").split(",")[0];
    ...
    utilsBle.nobleCaracteristicRead(characteristic, function () {
      characteristic.on('read', function (data, isNotification) {
        ...
        if (data && isNotification) {
          ...
          let pulse_low = data.readInt8(12);
          console.log("low", pulse_low);
          pulse_low &= 0b01111111;

          let pulse_high = data.readInt8(11);
          console.log("high", pulse_high);
          ...
          if (spo2LoopControl > 0) {
            ...
            console.log("counter", spo2Counter);
            let newDataSensors = [];
            newDataSensors["spo2"] = (spo2Avg / spo2Counter);
            newDataSensors["pulse"] = (pulse_spo2Avg / spo2Counter);
