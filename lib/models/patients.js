...
Patient.prototype.getInfoPatient = function (userid, examBle, res, callback) {
  this.patientdb.aggregate([
    ...
    { "$project": { "_id": 0, "id": 1, "birthdate": 1, "gender": 1, "height": 1, "weight": 1, "bandfitness_auth": 1, "Boards.id": 1, "Boards.mac_addr": 1, "Boards.Boardmodel.id": 1, "Boards.Boardmodel.tag": 1, "Boards.Boardmodel.Sensors": 1 }}], 
    function (err, patient) {
      ...
      let patientInfo = {
        ...
        Sensors: patient[0].Boards.Boardmodel.Sensors
      }
