...
Sensor.prototype.getSensorLimits = function (type, loc, callback, res) {
  this.sensordb.find(
    { sensortype: type, location: loc }, {
    "threshold_max_acceptable": 1,
    "threshold_max_possible": 1,
    "threshold_min_acceptable": 1,
    "threshold_min_possible": 1,  
  }, (err, result) => {
    if (err) {
      return res.json({
        status: false,
