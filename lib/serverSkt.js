...
function KeyCMD(cmd) {
  switch (cmd) {
    ...
    case "message":
      ...
      serverBoardManager.buildObject('60ab', 'diox', '600', serverBoardManager.sensor_list)
      serverBoardManager.buildObject('60ab', 'temp', '600', serverBoardManager.sensor_list)
      serverBoardManager.buildObject('60ab', 'humi', '600', serverBoardManager.sensor_list)
      /*blinkMessage(type, {
        type: 'notification',
