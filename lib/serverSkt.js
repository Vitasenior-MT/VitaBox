...
var NodeCEC = require('./nodecec.js'),
    ...
    timeCount = 0,
    timeToWait = 1000,
    waitingTimeTillNextWarning = timeCalculator(0, 5, 0), // In case the configs fail the time wont be messed up
    waitingTimeTillCheckForCecIsAlive = timeCalculator(0, 0, 4), // In case the configs fail the time wont be messed up
    waitingTime = 1,
...
var ServerSktIo = function (options) {
    ...
    waitingTimeTillNextWarning = timeCalculator(this.TimersConfig.waitingTimeTillNextWarning.hour, this.TimersConfig.waitingTimeTillNextWarning.min, this.TimersConfig.waitingTimeTillNextWarning.sec);
    waitingTimeTillCheckForCecIsAlive = timeCalculator(this.TimersConfig.waitingTimeTillCheckForCecIsAlive.hour, this.TimersConfig.waitingTimeTillCheckForCecIsAlive.min, this.TimersConfig.waitingTimeTillCheckForCecIsAlive.sec);
};
