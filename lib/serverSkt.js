...
ServerSktIo.prototype.init = function() {
    ...
    this.io.on("connection", function(socket) {
        ...
        socket.on("rumSendMsg", function(data){
            ...
            console.log("Send msg", 'tx ' + monitor.GetPhysicalAddress().split(".")[0] + "f:64:" + data.optmsg + ":" +  msg2);
            monitor.WriteRawMessage('tx ' + monitor.GetPhysicalAddress().split(".")[0] + "f:64:" + data.optmsg + ":" +  msg2);
        });
