...
ServerSktIo.prototype.init = function () {
  ...
  this.io.on("connection", function (socket) {
    ...
    socket.on('saveWifiSettings', function (data) {
...
function connectionsList() {
  if (sckOn) {
    wifi.startScan();
    sendOutPutMsg('connectionsList', wifi.list);
  }
}
 ...
 * @param { source hdmi } hdmi
 * @param { nome da ligação } osdName
 */
 ...
 * @param { texto a ser enviado para a tv } text
 */
