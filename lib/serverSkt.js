...
function KeyCMD(cmd) {
  switch (cmd) {
    ...
    case "message":
      ...
      console.log(serverBoardManager.sensor_list[0]);
      serverBoardManager.buildObject(serverBoardManager.sensor_list[0].nodeId, 'mono', '600', serverBoardManager.sensor_list)
      /*blinkMessage(type, {
        type: 'notification',
      ...
      break;
    case "notifications":
      console.log('Entrou!!! notifications');
