...
module.exports = {
  ...
  execBleDisp: function (req, res) {
    ...
    patientslib.getPatientInfo(args.pacientId, args.action, res, function (pacientInfoMac) {
      ...
      args.options = {
        bandfitness_auth: pacientInfoMac[0].bandfitness_auth,                       // autenticação da band
