...
module.exports = {
  ...
  getFlgData: function (req, res) {
    Setting.getFlgData(res); 
  },
  updateFlagBandFit: function(data, res){
    Setting.updateFlagBandFit(data.flag, res);
  },
  updateDeviceType: function(data, res){
    Setting.updateDeviceType(data.type, res);
  },
  updateSFlgMDevice: function(data, res){
    Setting.updateSFlgMDevice(data.flag, res);
  }
}
