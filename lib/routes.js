...
routes.get("/api/sensor/getSensorsWithLocation/:location", sensorlib.getAllSensorsByLocation);
...
routes.get("/api/sensor/getDistictAllLocations", sensorlib.getDistictAllLocations);
...
routes.get('/api/rawsensor/getSensorDataByLocation/:location', rawsensorlib.getSensorDataByLocation);
...
routes.get("/api/settings/getFlagBandFit", settingslib.getFlagBandFit);
routes.post("/api/settings/updateFlgScreen/:flg", settingslib.updateFlgScreen);
...
routes.get('/api/connectServer/getUsers', connectServerlib.getUsers);
