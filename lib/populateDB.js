...
var self = module.exports = {
  ...
  addRemoteCommands: function () {
    Remote.insertMany([
      ...
      { name: 'key_6', code: '26', task: 'message', timed_flg: false },
      ...
      { name: 'key_green', code: 'green', task: 'settings', timed_flg: false }
    ]);
  },
      ...
      Sensors.insertMany([
        {
          ...
          unit: "ºC",
          to_read: "ºC",
          threshold_max_acceptable: 22,
          threshold_max_possible: 30,
          threshold_min_acceptable: 15,
          threshold_min_possible: -5
        },
        {
        ...
        },
        {
          ...
          unit: "ppm",
          to_read: "ppm",
          threshold_max_acceptable: 10,
          threshold_max_possible: 20,
          threshold_min_acceptable: 5,
          threshold_min_possible: 0
        },
        {
    ...
    RawSensors.countRawSensors(function () {
      ...
      for (let index = 0; index < numSensorSeeds; index++) {
        ...
        sensorArr.push({
          ...
          measure: "Humidade",
          datetime: d,
          value: self.randomIntFromInterval(20, 60),
          flg_available: true
        }, {
            id: "",
            board_id: "4ac4847d-46d9-4c1c-bfe7-4eda8ce23100",
            ...
            measure: "Temperatura",
            datetime: d,
            value: self.randomIntFromInterval(-5, 30),
            flg_available: true
          }, {
            id: "",
            board_id: "fc7f8ed2-f73e-4ff3-827c-f8cea42aa962",
            ...
            measure: "CO",
            datetime: d,
            value: self.randomIntFromInterval(0, 20),
            flg_available: true
          }, {
            id: "",
            board_id: "4ac4847d-46d9-4c1c-bfe7-4eda8ce23123",
