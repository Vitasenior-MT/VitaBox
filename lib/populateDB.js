...
module.exports = {
  ...
  addRemoteCommands: function(){
    Remote.countRemoteCmd(function(){
      Remote.insertAllRemoteCmd([
        ...
        {name: 'key_up', code: '1', task: 'none', timed_flg: false},
        {name: 'key_down', code: '2', task: 'none', timed_flg: false},
  ...
  //TODO: verificar se é mesmo eliminar
  addWarnings: function(){
    Warnings.countWarnings(function(){
      Warnings.insertAllWarnings([
        {
          warning_type: 'temp',
          header: 'Perigo de desidratação!',
          message: 'Niveis de Temperatura demasiado altos.',
          footer: 'Perigo de desidratação!',
          color: 'red'
        }, {
          warning_type: 'co2',
          header: 'Perigo Iminente de Fogo!',
          message: 'Niveis de Dioxido de Carbono demasiado altos.',
          footer: 'Perigo Iminente de Fogo!',
          color: 'red'
        }, {
          warning_type: 'monoxido',
          header: 'Perigo Iminente de intoxicação!',
          message: 'Niveis de Monóxido de Carbono demasiado altos.',
          footer: 'Perigo Iminente de intoxicação!',
          color: 'red'
        }, {
          warning_type: 'all',
          header: 'Perigos Vários!',
          message: 'N/A',
          footer: 'Perigos Vários!',
          color: 'red'
        }]);
    });
  },
