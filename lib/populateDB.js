  ...
  addPatients: function () {
    Patient.count(function () {
      Patient.insert({
        patients: [
          {
            name: 'José António', gender: 'male', birthdate: '1987-02-28', since: '2018-03-19', id: '02d3468c-d8b7-4895-a678-71f2efa715d1', device_list: {
              bloodpressure: true,
          ...
          {
            name: 'Manuela Antonieta', gender: 'female', birthdate: '1972-02-28', since: '2018-03-19', id: '02d3468c-d8b7-4895-a678-71f2efa715dd', device_list: {
              bloodpressure: true,
              body_temperature: false,
              body_pulse: true,
              body_scale: false,
