...
module.exports = {
  ...
  getDistictAllLocations: function (req, res) {
    Sensor.getDistictAllLocations(res);
  },
  getThresholds: function (req, res) {
    Sensor.getThresholds(req.params, res);
  },
  getSensorsWithLocation: function (req, res) {
    Sensor.getSensorsWithLocation(req.params, res);
  }
}
