...
ServerBoardWarnings.prototype.sendData = function (data, iptables) {
	var self = this;
...
process.on("message", function (data, iptables) {
	if (data.thresholds) {
		sbr.sendData(data.thresholds, iptables);
	} else {
