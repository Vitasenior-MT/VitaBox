...
function processNumbers(array, val) {
    ...
    if (valN01.length === 2) {
        ...
        prossNums(array, (parseInt(val)).toString(), 0);
    }
}

function prossNum(array, valN, type) {
    console.log(valN);
    console.log(parseInt(valN[0]));
    console.log(parseInt(valN[1]));
    prossNums(array, parseInt(valN[0]).toString(), 0);
    array.push(filePathName('numbers', type));
    prossNums(array, parseInt(valN[1]).toString(), 0);
}
