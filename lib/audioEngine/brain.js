...
function prossNums(array, num, index) {
    console.log('prossNums: ', array, num, index);
    index = index++;
    ...
    if (num && expNum) {
        if (expNum === 1 || parseInt(num) < 20) {
            ...
            if (parseInt(num) === 100) {
                ...
                let numTansformed = num - num[index] * Math.pow(10, (expNum - index - 1));
                array.push(filePathName('numbers', num[index] * Math.pow(10, (expNum - index - 1))));
                array.push(filePathName('numbers', 'e'));
                console.log('*******************************');
                console.log(num);
                console.log(num[index] * Math.pow(10, (expNum - index - 1)));
                console.log(numTansformed);
                prossNums(array, numTansformed, index);
            }
