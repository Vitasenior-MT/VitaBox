            ...
            for (let i = 0; i < expNum; i++) {
                if (parseInt(data[0]) !== 0) {
                    if (parseInt(data) === 100) {
                        ...
                        let numTansformed = data - data[0] * Math.pow(10, (expNum - 0 - 1));
                        console.log('*******************************');
                        console.log(data);
                        console.log(data[0] * Math.pow(10, (expNum - 0 - 1)));
                        console.log(numTansformed);
                        array.push(filePathName('numbers', data[0] * Math.pow(10, (expNum - 0 - 1))));
                        if (numTansformed > 0) {
                            array.push(filePathName('numbers', 'e'));
                            data = numTansformed;
                        }
